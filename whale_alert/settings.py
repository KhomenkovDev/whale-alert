...
# Channel Layers — auto-detect Redis if configured
channel_layer_type = env("CHANNEL_LAYER_TYPE", default="memory")
...
USDC_CONTRACT_ADDRESS = env(
    "USDC_CONTRACT_ADDRESS", default="0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48"
)
...
# Rate limiting
AI_REPORT_RATE_LIMIT = env("AI_REPORT_RATE_LIMIT", default="10/hour")
